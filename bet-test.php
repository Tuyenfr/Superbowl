   ...
   <div class="flux">
      ...
      <div class="container_connexion">
         ...
         try {
            ...
            foreach ($pdo->query('SELECT * FROM bets WHERE user_id = ".$user_id."', PDO::FETCH_ASSOC) as $bet) {
               ...
               if ($bet_match_id === $match_id) {
                  ...
                  echo '<br>';
                  echo 'Souhaitez-vous conserver la mise actuelle ? ';
         ?>

                  <form method="POST" action="bet_user_update.php">

                     <label for="maintain_mybet">Oui</label>
                     <input type="text" name="maintain_mybet" placeholder="Cochez Oui">

                     <label for="update_mybet">Non</label>
                     <input type="text" name="update_mybet" placeholder="Cochez Non">

                     <div>
                        <input type="hidden" name="match_id" value="<?= $bet_match_id; ?>">
                        <input type="hidden" name="bet_team" value="<?= $bet_team; ?>">
                        <input type="hidden" name="bet_team1" value="<?= $bet_team1 ?>">
                        <input type="hidden" name="bet_draw" value="<?= $bet_draw ?>">
                        <input type="hidden" name="bet_team2" value="<?= $bet_team2 ?>">
